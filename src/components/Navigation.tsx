					...
					<div className="rounded-2xl bg-background shadow-2xl py-3 md:py-4 px-2 sm:px-4 md:px-8 flex items-center justify-between backdrop-blur-lg border border-border/40 supports-[backdrop-filter]:bg-background/80 transition-all duration-300 w-full">
						...
						<div className="flex items-center gap-4 sm:gap-6 flex-shrink-0 min-w-0">
							...
							<button
								...
								className="xl:hidden flex items-center justify-center rounded-md p-2 hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary/50"
							...
							<Link
								to="/"
								className="text-xl md:text-2xl font-bold text-primary whitespace-nowrap select-none overflow-hidden text-ellipsis"
							>
								Schedulr
							</Link>
						</div>
										...
										>
											...
											<span
												className={`relative inline overflow-hidden text-ellipsis after:block after:h-[3px] after:rounded-full after:scale-x-0 after:transition-transform after:duration-200 after:ease-in-out after:origin-left group-hover:after:scale-x-100 group-focus:after:scale-x-100 ${
													isActive
														? 'text-green-500 after:scale-x-100 after:bg-green-500'
														: 'group-hover:text-green-500 group-focus:text-green-500 after:bg-green-500'
												}`}
											>
												{item.name}
											</span>
				...
				>
					...
					>
						...
						<div className="flex flex-col gap-2">
							...
							<Link key="/" to="/" onClick={() => setIsOpen(false)}>
								<div
